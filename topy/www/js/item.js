...
var Cresselia =  new pokemon("Cresselia",
 ...
 "Cresselia.png");
var Darkrai =  new pokemon("Dialga",
 "Darkrai (anglais : Darkrai ; japonais : ダークライ Darkrai[1]) est un Pokémon fabuleux de la quatrième génération de type Ténèbres. Il fait partie du Duo lunaire avec Cresselia.Il maîtrise le sommeil de chacun, il peut produire des rêves, mais crée également des cauchemars, qui peuvent conduire à la mort de la victime. ",
 "Darkrai.png");

 arrayPokemon.push(Dialga,Palkia,Regigigas,Giratina,Cresselia,Darkrai);